                    ...
                    <table className="w-full">
                        <thead>
                            <tr className="bg-gray-50/80 border-b border-gray-100">
                                <th className="text-left px-4 py-3 text-[10px] font-black text-gray-500 uppercase tracking-widest">Outage ID</th>
                                <th className="text-left px-4 py-3 text-[10px] font-black text-gray-500 uppercase tracking-widest">Type</th>
                                <th className="text-left px-4 py-3 text-[10px] font-black text-gray-500 uppercase tracking-widest">Date & Time</th>
                                <th className="text-left px-4 py-3 text-[10px] font-black text-gray-500 uppercase tracking-widest">Equipment Type / Equipment</th>
                                ...
                                <th className="text-left px-4 py-3 text-[10px] font-black text-gray-500 uppercase tracking-widest">Understudy / Remarks</th>
                                <th className="text-left px-4 py-3 text-[10px] font-black text-gray-500 uppercase tracking-widest">Planner / TOMS / GNC</th>
                                <th className="text-center px-3 py-3 text-[10px] font-black text-gray-500 uppercase tracking-widest"></th>
                            </tr>
                        </thead>
                        <tbody>
                            {filteredOutages.map((outage) => (
                                <tr
                                    key={outage.id}
                                    className="hover:bg-gray-50/50 transition-colors group border-t border-gray-50"
                                >
                                    ...
                                    <td className="px-4 py-3">
                                        <span className={`text-[10px] font-black px-2 py-1 rounded-full border uppercase tracking-wider whitespace-nowrap ${getTypeStyle(outage.type)}`}>
                                            {outage.type}
                                        </span>
                                    </td>
                                    <td className="px-4 py-3">
                                        <p className="text-xs font-bold text-gray-900 whitespace-nowrap">{outage.date}</p>
                                        <p className="text-[11px] text-gray-400 font-medium whitespace-nowrap">{outage.time}</p>
                                    </td>
                                    <td className="px-4 py-3">
                                        <p className="text-[10px] font-black text-gray-400 uppercase tracking-widest">{outage.equipmentType}</p>
                                        <p className="text-xs font-bold text-gray-800">{outage.equipment}</p>
                                    </td>
                                    <td className="px-4 py-3">
                                        <span className={`text-[10px] font-black px-2.5 py-1 rounded-full border uppercase tracking-wider whitespace-nowrap ${getStatusStyle(outage.status)}`}>
                                            {outage.status}
                                        </span>
                                    </td>
                                    <td className="px-4 py-3 max-w-[220px]">
                                        <p className="text-xs text-gray-600 leading-snug">{outage.description}</p>
                                    </td>
                                    <td className="px-4 py-3 max-w-[220px]">
                                        <p className="text-xs text-gray-500 leading-snug">{outage.studyRemarks}</p>
                                    </td>
                                    <td className="px-4 py-3">
                                    ...
                                    <td className="px-3 py-3 text-center">
                                        <button className="p-1.5 text-gray-300 hover:text-gso-green transition-colors">
